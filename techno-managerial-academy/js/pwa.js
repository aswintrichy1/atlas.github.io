/* TechLead — installable-PWA support (progressive enhancement).
 *
...
(function () {
  ...
  // True when TechLead is already running as an installed / standalone app.
  ...
  function buildButton() {
    ...
    btn.title = "Install TechLead as an app";
    ...
    try {
      ...
      if (t && t.classList) {
        ...
        t.appendChild(document.createTextNode(
          "TechLead installed — launch it any time, fully offline."));
        t.classList.add("show");
        setTimeout(function () { t.classList.remove("show"); }, 2400);
        return;
      }
    } catch (e) { /* confirmation is non-essential — ignore */ }
    try { if (window.console && console.info) console.info("TechLead installed."); }
    catch (e2) { /* ignore */ }
  }
